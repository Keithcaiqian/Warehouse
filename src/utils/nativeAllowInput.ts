...
// 以大写字母开头只允许大写字母、数字和下划线（_）
export function firstUpperChar_includes_UpperChar_Num_Underscores (value: string){
    return !value || /^[A-Z][A-Z0-9_]*$/.test(value);
}

// 以字母开头只允许字母、数字和下划线（_）
export function firstUpperChar_includes_Char_Num_Underscores (value: string){
...
// 0 - 10
export function zeroToTen (value: string){
